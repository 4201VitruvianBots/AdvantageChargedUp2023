        ...
        new RepeatCommand(
            new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        new AutoSetSetpoint(
                            stateHandler, elevator, wrist, SETPOINT.SCORE_HIGH_CONE),
                        new AutoSetIntakeSetpoint(
                            intake, INTAKE_STATE.HOLDING_CONE, vision, swerveDrive))
                ...
                new ParallelCommandGroup(
                    ...
                    new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                                new AutoSetSetpoint(
                                    stateHandler, elevator, wrist, SETPOINT.INTAKING_EXTENDED_CONE),
                                new AutoSetIntakeSetpoint(
