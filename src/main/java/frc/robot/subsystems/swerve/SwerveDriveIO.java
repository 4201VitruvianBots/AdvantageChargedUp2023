...
public class SwerveDriveIO extends SubsystemBase implements AutoCloseable {
  ...
  private final LoggedTunableNumber SwerveKp_X = new LoggedTunableNumber("Swerve/SwerveKp_X");

  private final LoggedTunableNumber SwerveKd_X = new LoggedTunableNumber("Swerve/SwerveKp_X");

  private final LoggedTunableNumber SwerveKp_Y = new LoggedTunableNumber("Swerve/SwerveKp_Y");

  private final LoggedTunableNumber SwerveKd_Y = new LoggedTunableNumber("Swerve/SwerveKd_Y");

  private final LoggedTunableNumber SwerveKp_Turn = new LoggedTunableNumber("Swerve/SwerveKp_Turn");
